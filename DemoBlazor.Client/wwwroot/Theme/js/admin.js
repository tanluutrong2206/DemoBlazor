...
$.AdminBSB.leftSideBar = {
    ...
    setMainContentHeight: function(){
        var height = $(window).height() - $('.navbar').innerHeight() - 20;
        $('#mainContent').height(height);
    },
    setRightContentHeight: function () {
        var height = $(window).height() - $('.navbar').innerHeight() - 10;
        $('#rightContent').height(height);
    },
    setMenuHeight: function (isFirstTime) {
        if (typeof $.fn.slimScroll != 'undefined') {
            var configs = $.AdminBSB.options.leftSideBar;
            var height = ($(window).height() - ($('.legal').outerHeight() + $('.navbar').innerHeight() + 135));
            var $el = $('.list');
